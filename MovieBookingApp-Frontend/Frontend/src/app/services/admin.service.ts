...
export class AdminService {
  ...
  updateTickets(request: TicketUpdate) {
    return this.http
      .put(`${constants.ADMIN_SERVICE_URL}/updateTickets`,request)
      .pipe(catchError(this.handleError));
  }

  addShows(request: TicketUpdate) {
    return this.http
      .put(`${constants.ADMIN_SERVICE_URL}/addShows`,request)
      .pipe(catchError(this.handleError));
  }
  ...
  deleteShowById(id: string) {
    return this.http
      .delete(`${constants.ADMIN_SERVICE_URL}/delete-show/${id}`)
      .pipe(catchError(this.handleError));
  }
